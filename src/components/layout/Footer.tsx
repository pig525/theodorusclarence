    ...
    <div className='mt-2 flex space-x-4'>
      <div className='flex items-center justify-center'>
        ...
        >
          <button
            onClick={() => {
              copy('babypig.dev525@gmail.com').then(() => {
...
const footerLinks: { href: string; text: string; tooltip: React.ReactNode }[] =
  [
    {
      href: 'https://github.com/pig525/theodorusclarence.com',
      text: 'Source Code',
      tooltip: (
        <>
    ...
    // },
    {
      href: 'https://github.com/pig525/starters',
